...
const SHAPES = [
  ...
  (id: string, c: string) => (
    <svg viewBox="0 0 400 400" className="absolute inset-0 h-full w-full">
      ...
      <line x1="0" y1="400" x2="400" y2="0" stroke={c} strokeOpacity={0.7} strokeWidth="1.5" />
    </svg>
  ),
  ...
  (id: string, c: string) => (
    <svg viewBox="0 0 400 400" className="absolute inset-0 h-full w-full">
      ...
      <line x1="52" y1="66" x2="360" y2="66" stroke={c} strokeOpacity={0.4} strokeWidth="1" />
    </svg>
  ),
];
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0"
        style={{
          background: `linear-gradient(180deg, transparent 40%, ${base}cc 100%)`,
        }}
      />
    </div>
  );
